...
// logic painding
  ...
  selectedMainImageShow() {
    return (selectedimage == null || selectedimage == "") && (widget.model.image != null || widget.model.image != '')
        ? Container()
        :Padding(
...
// logic painding
  ...
  uploadedOtherImageShow() {
    return (selectedimage2 == null || selectedimage2 == "") && (widget.model.otherImages != null || widget.model.otherImages != '')
        ? Container()
        :Padding(
      padding: const EdgeInsets.symmetric(horizontal: 10),
      child: ClipRRect(
      ...
      child: Form(
        ...
        child: Column(
          children: [
            ...
            selectedMainImageShow(),
            (selectedimage == null || selectedimage == "") && (widget.model.image == null || widget.model.image == '') ? Container() :
            (selectedimage == null || selectedimage == "") && (widget.model.image != "" || widget.model.image != null  ) ?
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 10),
              child: ClipRRect(
                borderRadius:
            ...
            (selectedimage2 == null || selectedimage2 == "") && (widget.model.otherImages != "" || widget.model.otherImages != null  ) ?
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 10),
              child: ClipRRect(
                borderRadius:
