...
import 'package:eshopmultivendor/Screen/dashboard.dart';
  ...
  Future<void> getLoginUser() async {
    ...
    apiBaseHelper.postAPICall(getUserLoginApi, data).then(
      (getdata) async {
        ...
        print("login response is == ${getdata['message']}");
       toast(getdata['message']);

        if(getdata['message'] == 'Your acount is deactivated'){
          await buttonController!.reverse();
          setState(() {},);
        }
         ...
         // setSnackbar(msg!);
          ...
          if(getdata['message'] != 'Your acount is deactivated')
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => RestaurantDashboard(title: "Dashboard"),
                ),
              );
