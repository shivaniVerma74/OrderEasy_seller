              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    child: Center(
                     child:
                     subCategoryModel?.data?.isEmpty ?? true ? Text(
                     getTranslated(context, "Not Selected Yet ...")!,
                     ):
                    DropdownButtonFormField<dynamic>(
                      ...
                      onChanged: (newValue) {
                        setState(() {
                          selectedSubCatName = newValue[0].name;
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: getTranslated(context, "selected subCategory"),
            ...
            curSelPos == 0
                ? Column(
                  ...
                  //         : Container(),
                      ...
                      // For Variant Product
                      _isStockSelected != null && _isStockSelected == true &&
                              productType == 'variable_product'
                              ...
                              OutlinedButton(
                                onPressed: () {
                                  if (attributeIndiacator ==
                                    ...
                                    setState(() {
                                      _attrController.add(new TextEditingController());
                                      _attrValController.add(new TextEditingController());
                                      variationBoolList.add(false);
                                    });
                                  } else {
                                    setSnackbar(getTranslated(context, "fill the box then add another")!);
                                  }
                                },
                                child: Text(
                              ...
                              OutlinedButton(
                                onPressed: () {
                                  ...
                                  setState(() {
                                    ...
                                    for (int i = 0; i < tempAttList.length; i++) {finalAttList.add(tempAttList[i]);}
                                    ...
                                    setSnackbar(getTranslated(context, "Attributes saved successfully")!,);
                                  });
                                },
                                child: Text(
  ...
  Future<void> addProductAPI(List<String> attributesValuesIds) async {
    ...
    if (_isNetworkAvail && (selectedimage != null || selectedimage != '')) {
      try {
        ...
        request.fields['sub_category_id'] = sub_cat_id.toString()??'';
...
//=========================== Body Part ========================================
  ...
  Future<CategoryModel?> getCat() async {
    ...
    print("get category request ${request.fields}");
