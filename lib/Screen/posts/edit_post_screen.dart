...
class _EditPostScreenState extends State<EditPostScreen> {
  ...
  Future<Null> getProduct(String top) async {
    if (readProduct) {
      ...
      if (_isNetworkAvail) {
        ...
        print("get producttsss parameye $parameter");
        // if (selId != null && selId != "") {
  ...
  Future<void> getFromGallery() async {
    final List<XFile>? result = await imgPicker.pickMultiImage();
    // var result = await FilePicker.platform.pickFiles(
    //   type: FileType.image,
    //   allowMultiple: true,
    // );
  ...
  updatePost() async{
    ...
    print('update_post_request==== ${request.fields}');
            ...
            children: [
              Card(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.all(Radius.circular(15)),
                      child: Image.file(File(imagePathList[index].path),
                          fit: BoxFit.cover),
                    ),
                  )),
              Positioned(
