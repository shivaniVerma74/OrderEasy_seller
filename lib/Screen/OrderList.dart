    ...
    return AppBar(
      ...
      title: Row(
        children: [
          ...
          ClipRRect(child: Image.network(appLogo!, fit: BoxFit.contain,height: 50,)),
        ],
      ),
      // title: appBarTitle,
      elevation: 5,
        ...
        : NotificationListener<ScrollNotification>(
            ...
            child: Column(
              children: [
                ...
                scrollGettingData || appLogo == null || appLogo == ""
                    ? Container(
                  height: 500,
              ...
              InkWell(
                ...
                child: Padding(
                  ...
                  child: Container(
                    height: 30,
                    width: 80,
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), color: secondary),
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 8.0, vertical: 5),
                      child: Row(
                        children: [
