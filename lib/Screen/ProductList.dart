...
import 'package:eshopmultivendor/Screen/editScreen.dart';
  ...
  Future<Null> getProduct(String top) async {
    if (readProduct) {
      ...
      if (_isNetworkAvail) {
        ...
        print("product_resparameter_____________$parameter");
        if (selId != null && selId != "") {
        ...
        apiBaseHelper.postAPICall(getProductsApi, parameter).then(
            ...
            if (!error) {
              ...
              if ((offset) < total) {
                ...
                print("product_res_____________$data");
        ...
        children: [
          ...
          Image.asset('assets/logo/mt_logo.png', fit: BoxFit.contain, height: 75,):
            ClipRRect(
                ...
                child: Image.network(appLogo!, fit: BoxFit.contain,width: 70,)),
