...
final Uri update_deliveryApi = Uri.parse(baseUrl + 'update_delivery');
final Uri updateStatusApi = Uri.parse(baseUrl + 'update_staff_status');
final Uri update_time_slotApi = Uri.parse(baseUrl + 'update_time_slot');
final Uri create_staffApi = Uri.parse(baseUrl + 'create_staff');
final Uri update_staffApi = Uri.parse(baseUrl + 'update_staff');
...
final Uri get_staffApi = Uri.parse(baseUrl + 'get_staff');
